  ...
  <body>
    <header>
      ...
      <div class="bar-search">
        <img class="img-explore" src="assets/src/icon/explore.png" alt="돋보기 아이콘" />
      ...
      <nav>
        <ul class="list-nav">
          <li><img src="assets/src/icon/home.png" alt="홈 아이콘" /></li>
          <li><img src="assets/src/icon/send.png" alt="다이렉트 메시지 아이콘" /></li>
          <li><img src="assets/src/icon/add.png" alt="게시물 추가 아이콘" /></li>
          <li><img src="assets/src/icon/compass.png" alt="탐색 아이콘" /></li>
          <li><img src="assets/src/icon/heart.png" alt="좋아요 아이콘" /></li>
            ...
            />
              ...
              <div class="wrap-menu">
                  <div class="menu-profile">
                    <img src="assets/src/icon/user.png" alt="프로필 아이콘" />
                    <p>프로필</p>
                  </div>
                  <div class="menu-bookmark">
                    <img src="assets/src/icon/bookmark.png" alt="프로필 아이콘" />
                    <p>저장됨</p>
                  </div>
                  <div class="menu-setting">
                    <img src="assets/src/icon/setting.png" alt="프로필 아이콘" />
                    <p>설정</p>
                  </div>
                  <div class="menu-change">
                    <img src="assets/src/icon/change.png" alt="프로필 아이콘" />
                    <p>계정 전환</p>
                  </div>
        ...
        <div class="box-story">
          <li>
            <img
              ...
              src="assets/src/img/profile/apple.jpg"
              alt="프로필 이미지"
            />
          ...
          <li>
            <img
              class="img-profile-56px img-story"
              src="assets/src/img/profile/peach.jpg"
              alt="프로필 이미지"
            />
        ...
        <div>
          <article class="box-feed">
            <div class="head-feed">
              ...
              <img class="icon-more" src="assets/src/icon/more.png" alt="더보기 아이콘" />
            </div>

            <img class="img-feed" src="assets/src/img/feed/apple.jpg" alt="피드 이미지" />

            <div class="icon-feed">
              <div>
                <img class="img-icon" src="assets/src/icon/heart.png" alt="하트 아이콘" />
                <img class="img-icon" src="assets/src/icon/chat.png" alt="댓글 아이콘" />
                <img
                  class="img-icon"
                  src="assets/src/icon/send.png"
                  alt="다이렉트 메시지 아이콘"
                />
              </div>
              <img
                class="img-icon"
                src="assets/src/icon/bookmark.png"
                alt="북마크 아이콘"
              />
            </div>
            ...
            <div class="box-chat">
              <img class="img-icon" src="assets/src/icon/smile.png" alt="이모지 아이콘" />
              <form>
                <input
                  class="input-chat"
                  type="text"
        ...
        <div class="box-myProfile">
          <div>
            <img
              ...
              src="assets/src/img/profile/candy.jpg"
              alt="프로필 이미지"
            />
            <p>candy_0426</p>
          </div>
        ...
        <div class="box-recommend">
          ...
          <div class="box-recommend-profile">
            <div class="profile-recommend">
              <img
                class="img-profile-32px"
                src="assets/src/img/profile/watermelon.jpg"
                alt="프로필 이미지"
              />
              <div>
          ...
          <div class="box-recommend-profile">
            <div class="profile-recommend">
              <img
                class="img-profile-32px"
                src="assets/src/img/profile/lemon.jpg"
                alt="프로필 이미지"
              />
              <div>
